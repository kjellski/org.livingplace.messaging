 ...
 * @author kjelllski
 */
public class LPSubscriber implements ILPSubscriber {
    ...
    public LPSubscriber(String topicName, ILPConnectionSettings s)
            throws JMSException {
    ...
    private void configure(String topicName, ILPConnectionSettings s)
            throws JMSException {
